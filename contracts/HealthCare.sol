...
contract HealthCare {
    ...
    function getAllRecords() public view returns (string[] memory allRecords) {
        string[] memory allUserRecords = new string[](recordsArr.length);
    ...
    function getAllRecordsLength() public view returns (uint256) {
